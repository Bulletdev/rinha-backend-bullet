...
public class ApiClient {
    ...
    new ServerConfiguration(
      "http://localhost:9999",
      "Servidor local através do Nginx (load balancer)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "http://localhost:8081",
      "Servidor API 01 (acesso direto)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "http://localhost:8082",
      "Servidor API 02 (acesso direto)",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:9999
